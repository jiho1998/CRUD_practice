...
public class Application {
    ...
    private static void chooseSubMenu() {
        ...
        do {
            ...
            switch (no) {
                case 1 : menuService.searchMenuBySubCategory(inputSupCategory());
                case 9 : return;
            }
        }while (true);
    }
    ...
    private static void trimSubMenu() {
        ...
        do{
            ...
            System.out.println("1. 검색 조건이 있는 경우 메뉴코드로 조회, 단 없으면 전체 조화");
            System.out.println("2. 메뉴 혹은 카테고리 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며, 검색 조건이 없는 경우 전체 검색");
    ...
    private static SearchCriteria inputAllOrOne() {
        ...
        boolean hashSearchValue = "예".equals(sc.nextLine())?true:false;
